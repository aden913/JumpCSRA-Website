...
const sendGiftCardEmail = async (data) => {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${EMAIL_SERVER_BASE_URL}/api/email/gift-card`, transformedData, {
            headers: {
                'Content-Type': 'application/json',
                'X-API-Key': EMAIL_SERVER_API_KEY,
                'Accept': 'application/json'
...
const sendAccountDeletionEmail = async (data) => {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${EMAIL_SERVER_BASE_URL}/api/email/account-deletion`, transformedData, {
            headers: {
                'Content-Type': 'application/json',
                'X-API-Key': EMAIL_SERVER_API_KEY,
                'Accept': 'application/json'
