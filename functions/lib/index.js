...
async function sendPendingBookingCartReminderEmail(booking, bookingId) {
    var _a, _b, _c;
    try {
        ...
        await (0, emailService_1.sendCartReminderEmail)({
            customerEmail,
            ...
            cartTotal: booking.totalAmount || booking.total || ((_a = booking.pricing) === null || _a === void 0 ? void 0 : _a.total) || ((_b = booking.orderDetails) === null || _b === void 0 ? void 0 : _b.totalAmount) || ((_c = booking.paymentDetails) === null || _c === void 0 ? void 0 : _c.totalAmount) || 0
        });
...
function getBookingCustomerId(booking) {
    return booking.customerID || booking.customerId || booking.userId;
}
function getBookingItems(booking) {
    var _a, _b;
    return booking.items || booking.rentalItems || booking.cartItems || ((_a = booking.bookingDetails) === null || _a === void 0 ? void 0 : _a.items) || ((_b = booking.orderDetails) === null || _b === void 0 ? void 0 : _b.items) || [];
}
function getBookingEventDate(booking) {
    var _a, _b;
    return booking.eventDate || ((_a = booking.orderDetails) === null || _a === void 0 ? void 0 : _a.eventDate) || ((_b = booking.bookingDetails) === null || _b === void 0 ? void 0 : _b.eventDate) || '';
}
function getBookingEventTimestamp(booking) {
...
function getBookingCreatedTimestamp(booking) {
    var _a, _b, _c;
    const rawCreatedAt = booking.createdAt ||
        ((_a = booking.orderDetails) === null || _a === void 0 ? void 0 : _a.createdAt) ||
        ((_b = booking.paymentDetails) === null || _b === void 0 ? void 0 : _b.createdAt) ||
        ((_c = booking.dashboardDetails) === null || _c === void 0 ? void 0 : _c.createdAt);
    if (!rawCreatedAt) {
        return NaN;
    }
...
function getBookingRemainingBalance(booking) {
    var _a, _b;
    return Number(booking.remainingBalance ||
        booking.balanceDue ||
        ((_a = booking.pricing) === null || _a === void 0 ? void 0 : _a.remainingBalance) ||
        ((_b = booking.paymentDetails) === null || _b === void 0 ? void 0 : _b.remainingBalance) ||
        0);
}
function getScheduledEmailBookingDetails(booking) {
    ...
    return {
        ...
        total: booking.totalAmount || booking.total || ((_a = booking.pricing) === null || _a === void 0 ? void 0 : _a.total) || ((_b = booking.orderDetails) === null || _b === void 0 ? void 0 : _b.totalAmount) || ((_c = booking.paymentDetails) === null || _c === void 0 ? void 0 : _c.totalAmount) || 0,
        amountPaid: booking.amountPaid || booking.paidAmount || ((_d = booking.pricing) === null || _d === void 0 ? void 0 : _d.amountPaid) || ((_e = booking.paymentDetails) === null || _e === void 0 ? void 0 : _e.depositAmount) || 0,
        remainingBalance: getBookingRemainingBalance(booking),
        address: booking.deliveryAddress || ((_f = booking.customerInfo) === null || _f === void 0 ? void 0 : _f.address) || ((_g = booking.bookingDetails) === null || _g === void 0 ? void 0 : _g.address) || ((_h = booking.orderDetails) === null || _h === void 0 ? void 0 : _h.deliveryAddress),
        setupTime: booking.deliveryTime || ((_j = booking.bookingDetails) === null || _j === void 0 ? void 0 : _j.setupTime) || ((_k = booking.orderDetails) === null || _k === void 0 ? void 0 : _k.deliveryTime),
        paymentType: booking.paymentType || ((_l = booking.paymentDetails) === null || _l === void 0 ? void 0 : _l.paymentType),
        paymentMethod: booking.paymentMethod || ((_m = booking.paymentDetails) === null || _m === void 0 ? void 0 : _m.paymentMethod),
        bookingStatus: booking.status
    };
}
async function markBookingEmailSent(db, bookingId, emailKey, now) {
    const nestedUpdates = {
        [emailKey]: true,
        [`${emailKey}SentAt`]: now
    };
...
function hasBookingEmailBeenSent(booking, emailKey) {
    var _a, _b, _c;
    if (((_a = booking.emails) === null || _a === void 0 ? void 0 : _a[emailKey]) === true) {
        return true;
    }
    if (emailKey === 'postEventThanks') {
        return ((_b = booking.emails) === null || _b === void 0 ? void 0 : _b.thanks) === true;
    }
    if (emailKey === 'rebookingReminder') {
        return ((_c = booking.emails) === null || _c === void 0 ? void 0 : _c.rebooking) === true;
    }
    return false;
}
...
async function canReceiveMarketingEmail(recipient) {
    var _a, _b;
    try {
        ...
        if (recipient.userId) {
            ...
            if (userDoc.exists) {
                return ((_a = userDoc.data()) === null || _a === void 0 ? void 0 : _a.canEmail) !== false;
            }
        }
        if (recipient.email) {
            const snapshot = await firestore
                ...
                .get();
            if (!snapshot.empty) {
                return ((_b = snapshot.docs[0].data()) === null || _b === void 0 ? void 0 : _b.canEmail) !== false;
            }
        }
    }
    catch (error) {
...
async function filterMarketingRecipients(recipients) {
...
async function processCartReminderEmails(db, now) {
    try {
