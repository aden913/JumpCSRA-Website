...
exports.setupPayPalPlansStandalone = void 0;
...
const PAYPAL_CLIENT_SECRET = ((_a = functions.config().paypal) === null || _a === void 0 ? void 0 : _a.client_secret) || process.env.PAYPAL_CLIENT_SECRET;
...
exports.setupPayPalPlansStandalone = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        if (existingProductDoc.exists) {
            ...
            productId = existingProduct === null || existingProduct === void 0 ? void 0 : existingProduct.productId;
        ...
        if (existingPlanDoc.exists) {
            ...
            planId = existingPlan === null || existingPlan === void 0 ? void 0 : existingPlan.planId;
        ...
        throw new functions.https.HttpsError('internal', 'PayPal setup failed', { error: errorMessage });
    }
});
//# sourceMappingURL=paypal-setup.js.map